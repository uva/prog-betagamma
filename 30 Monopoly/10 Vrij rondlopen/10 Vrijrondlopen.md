...
Schrijf een functie `simuleer_groot_aantal_potjes_Monopoly()` die een groot aantal potjes kan simuleren door steeds de functie `simuleer_potje_Monopoly()` aan te roepen:
